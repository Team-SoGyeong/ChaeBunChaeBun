 ...
 * Use the {@link CategoryMushroomFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CategoryMushroomFragment extends Fragment {
    ...
    private RecyclerView categoryMushroomList;
     ...
     * @return A new instance of fragment CategoryMushroomFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CategoryMushroomFragment newInstance(String param1, String param2) {
        CategoryMushroomFragment fragment = new CategoryMushroomFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View categoryMushroom = inflater.inflate(R.layout.fragment_category_mushroom, container, false);

        categoryMushroomList = categoryMushroom.findViewById(R.id.mushroom_list);
        categoryNoList = categoryMushroom.findViewById(R.id.mushroom_nolist);
        ...
        if(categoryListItems.isEmpty()) {
            ...
            categoryMushroomList.setLayoutManager(cLayoutManager);
            categoryListAdapter = new CategoryListAdapter(categoryListItems);
            categoryMushroomList.setAdapter(categoryListAdapter);
        ...
        writing = (ImageButton) categoryMushroom.findViewById(R.id.mushroom_newbtn);
