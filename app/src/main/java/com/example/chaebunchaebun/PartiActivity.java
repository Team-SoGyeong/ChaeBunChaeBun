            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    case R.id.menu_writing:
                        Toast.makeText(PartiActivity.this, "소분 시작하기", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_all:
                        Toast.makeText(PartiActivity.this, "전체 소분팟", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_partici:
                        Toast.makeText(PartiActivity.this, "참가하고있는 소분팟", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_lead:
                        Toast.makeText(PartiActivity.this, "주최하고있는 소분팟", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_membership:
                        Toast.makeText(PartiActivity.this, "회원정보 수정/탈퇴", Toast.LENGTH_SHORT).show();
                        break;
                }
