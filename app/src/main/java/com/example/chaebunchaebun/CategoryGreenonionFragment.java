 ...
 * Use the {@link CategoryGreenonionFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CategoryGreenonionFragment extends Fragment {
    ...
    private RecyclerView categoryGreenonionList;
     ...
     * @return A new instance of fragment CategoryGreenonionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CategoryGreenonionFragment newInstance(String param1, String param2) {
        CategoryGreenonionFragment fragment = new CategoryGreenonionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View categoryGreenonion = inflater.inflate(R.layout.fragment_category_greenonion, container, false);

        categoryGreenonionList = categoryGreenonion.findViewById(R.id.greenonion_list);
        categoryNoList = categoryGreenonion.findViewById(R.id.greenonion_nolist);
        ...
        if(categoryListItems.isEmpty()) {
            ...
            categoryGreenonionList.setLayoutManager(cLayoutManager);
            categoryListAdapter = new CategoryListAdapter(categoryListItems);
            categoryGreenonionList.setAdapter(categoryListAdapter);
        ...
        writing = (ImageButton) categoryGreenonion.findViewById(R.id.greenonion_newbtn);
