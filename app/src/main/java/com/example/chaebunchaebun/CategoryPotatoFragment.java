 ...
 * Use the {@link CategoryPotatoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CategoryPotatoFragment extends Fragment {
    ...
    private RecyclerView categoryPotatoList;
     ...
     * @return A new instance of fragment CategoryPotatoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CategoryPotatoFragment newInstance(String param1, String param2) {
        CategoryPotatoFragment fragment = new CategoryPotatoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        categoryPotatoList = categoryPotato.findViewById(R.id.potato_list);
        categoryNoList = categoryPotato.findViewById(R.id.potato_nolist);
        ...
        if(categoryListItems.isEmpty()) {
            ...
            categoryPotatoList.setLayoutManager(cLayoutManager);
            categoryListAdapter = new CategoryListAdapter(categoryListItems);
            categoryPotatoList.setAdapter(categoryListAdapter);
