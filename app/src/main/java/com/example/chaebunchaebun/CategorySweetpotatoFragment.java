...
public class CategorySweetpotatoFragment extends Fragment {
    ...
    private RecyclerView categorySweetpotatoList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        categorySweetpotatoList = categorySweetpotato.findViewById(R.id.sweetpotato_list);
        categoryNoList = categorySweetpotato.findViewById(R.id.sweetpotato_nolist);
        ...
        if(categoryListItems.isEmpty()) {
            ...
            categorySweetpotatoList.setLayoutManager(cLayoutManager);
            categoryListAdapter = new CategoryListAdapter(categoryListItems);
            categorySweetpotatoList.setAdapter(categoryListAdapter);
