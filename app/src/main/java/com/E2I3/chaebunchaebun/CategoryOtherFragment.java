 ...
 * Use the {@link CategoryOtherFragment#newInstance} factory method to
...
public class CategoryOtherFragment extends Fragment {
    ...
    private RecyclerView categoryOtherList;
     ...
     * @return A new instance of fragment CategoryOtherFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CategoryOtherFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View categoryother = inflater.inflate(R.layout.fragment_category_other, container, false);

        categoryOtherList = categoryother.findViewById(R.id.other_list);
        categoryNoList = categoryother.findViewById(R.id.other_nolist);
        ...
        if(categoryListItems.isEmpty()) {
            ...
            categoryOtherList.setLayoutManager(cLayoutManager);
            categoryListAdapter = new CategoryListAdapter(categoryListItems);
            categoryOtherList.setAdapter(categoryListAdapter);
        ...
        writing = (ImageButton) categoryother.findViewById(R.id.other_newbtn);
