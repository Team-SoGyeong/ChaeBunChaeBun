...
public class CommunityNoseeDialogFragment extends DialogFragment {
    public static final String TAG_EVENT_DIALOG = "dialog_nosee";

    String userId, postId = null;
    RadioButton radioButton;

    public CommunityNoseeDialogFragment() {}
    public static CommunityNoseeDialogFragment getInstance() {
        CommunityNoseeDialogFragment e = new CommunityNoseeDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View noseeDialog = inflater.inflate(R.layout.dialog_community_nosee, container);
        getDialog().getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));

        ImageButton noseeDialogOk = (ImageButton) noseeDialog.findViewById(R.id.community_nosee_dialog_ok);
        ImageButton noseeDialogCancel = (ImageButton) noseeDialog.findViewById(R.id.community_nosee_dialog_cancel);
        RadioGroup noseeRadioGroup = (RadioGroup) noseeDialog.findViewById(R.id.community_nosee_radiogroup);
        RadioButton partici = (RadioButton) noseeDialog.findViewById(R.id.community_partici);
        RadioButton manySee = (RadioButton) noseeDialog.findViewById(R.id.community_many_see);
