 ...
 * Use the {@link CategoryGreenvegeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CategoryGreenvegeFragment extends Fragment {
    ...
    private RecyclerView categoryGreenvegeList;
     ...
     * @return A new instance of fragment CategoryGreenvegeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CategoryGreenvegeFragment newInstance(String param1, String param2) {
        CategoryGreenvegeFragment fragment = new CategoryGreenvegeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View categoryGreenvege = inflater.inflate(R.layout.fragment_category_greenvege, container, false);

        categoryGreenvegeList = categoryGreenvege.findViewById(R.id.greenvege_list);
        categoryNoList = categoryGreenvege.findViewById(R.id.greenvege_nolist);
        ...
        if(categoryListItems.isEmpty()) {
            ...
            categoryGreenvegeList.setLayoutManager(cLayoutManager);
            categoryListAdapter = new CategoryListAdapter(categoryListItems);
            categoryGreenvegeList.setAdapter(categoryListAdapter);
        ...
        writing = (ImageButton) categoryGreenvege.findViewById(R.id.greenvege_newbtn);
