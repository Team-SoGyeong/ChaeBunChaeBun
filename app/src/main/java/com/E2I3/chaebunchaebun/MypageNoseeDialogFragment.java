...
public class MypageNoseeDialogFragment extends DialogFragment {
    public static final String TAG_EVENT_DIALOG = "dialog_nosee";

    String userId, postId = null;
    RadioButton radioButton;

    public MypageNoseeDialogFragment() {}
    public static MypageNoseeDialogFragment getInstance() {
        MypageNoseeDialogFragment e = new MypageNoseeDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View noseeDialog = inflater.inflate(R.layout.dialog_mypage_nosee, container);
        getDialog().getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));

        ImageButton noseeDialogOk = (ImageButton) noseeDialog.findViewById(R.id.mypage_nosee_dialog_ok);
        ImageButton noseeDialogCancel = (ImageButton) noseeDialog.findViewById(R.id.mypage_nosee_dialog_cancel);
        RadioGroup noseeRadioGroup = (RadioGroup) noseeDialog.findViewById(R.id.mypage_nosee_radiogroup);
        RadioButton partici = (RadioButton) noseeDialog.findViewById(R.id.mypage_partici);
        RadioButton manySee = (RadioButton) noseeDialog.findViewById(R.id.mypage_many_see);
